        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div style="text-align: center">
                    <form class="" action="<?php echo site_url() ?>/admin_tables_q5" method="POST">
                ...
                <table id="example" class="display responsive nowrap" style="width:100%">
                    <thead>
                        <tr style="text-align: center">
                            <th colspan="2">Did any of the activities help you gain a clearer understanding of the subject?</th>
                        </tr>
                        <tr>
                            <th>Response</th>
                            <th>Count</th>
