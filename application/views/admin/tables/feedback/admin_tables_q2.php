    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-bar-chart"></i> Feedback Question 2 </div>
            <div class="card-body">
                <div style="text-align: center">
                    <form class="" action="<?php echo site_url() ?>/admin_tables_q2" method="POST">
                ...
                <table id="example" class="display responsive nowrap" style="width:100%">
                    <thead>
                        <tr style="text-align: center">
                            <th colspan="2">How would you rate the amount of material covered?</th>
                        </tr>
                        <tr>
                            <th>Rating</th>
                            <th>Count</th>
