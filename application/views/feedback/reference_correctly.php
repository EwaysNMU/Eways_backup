<br><br><br>
<div class="container">
    <h2 class="text-center">REFERENCE CORRECTLY FEEDBACK</h2><br>

    <?php $attributes = array('class' => 'was-validated', 'id' => 'reference_correctly_feedback_answer'); ?>
    <?php echo form_open('reference_correctly_feedback_answer_', $attributes); ?>
    <form>
