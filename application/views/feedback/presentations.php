<br><br><br>
<div class="container">
    <h2 class="text-center">MAKING BETTER PRESENTATIONS FEEDBACK</h2><br>

    <?php $attributes = array('class' => 'was-validated', 'id' => 'presentations_feedback_answer'); ?>
    <?php echo form_open('presentations_feedback_answer_', $attributes); ?>
    <form>
