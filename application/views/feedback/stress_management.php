<br><br><br>
<div class="container">
    <h2 class="text-center">STRESS MANAGEMENT FEEDBACK</h2>

    <?php $attributes = array('class' => 'was-validated', 'id' => 'stress_management_feedback_answer_'); ?>
    <?php echo form_open('stress_management_feedback_answer_', $attributes); ?>
