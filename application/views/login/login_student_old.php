        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <?php echo form_open('login_student_validation', $attributes); ?>
                                ...
                                <div class="card-body">
                                    <form class="form" role="form" autocomplete="off" id="formLogin" novalidate="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="number" placeholder="216959956" class="form-control form-control-lg rounded-0" name="studentno" id="email" required="">
