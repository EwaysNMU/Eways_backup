...
<div class="container">
  ...
  <div class="row scrollmenu">
    <div class="column">
        <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide1.jpg" style="width:100%" onclick="currentSlide(1)">
    </div>
    <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide2.jpg" style="width:100%" onclick="currentSlide(2)">
    </div>
    <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide3.jpg" style="width:100%" onclick="currentSlide(3)">
    </div>
    <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide4.jpg" style="width:100%" onclick="currentSlide(4)">
    </div>
    <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide5.jpg" style="width:100%" onclick="currentSlide(5)">
    </div>    
    <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide6.jpg" style="width:100%" onclick="currentSlide(6)">
    </div>
      <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide7.jpg" style="width:100%" onclick="currentSlide(7)">
    </div>
      <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide8.jpg" style="width:100%" onclick="currentSlide(8)">
    </div>
      <div class="column">
      <img class="demo cursor" src="<?php echo base_url() ?>assets/images/topics/stress_management/slide9.jpg" style="width:100%" onclick="currentSlide(9)">
    </div>
  </div>
</div>
<br>
...
<br>
<div align="center">
    <i>"The greatest weapon against stress is our ability to chose one thought over another".
    </i><br>
    - <b>William James</b>
</div>
