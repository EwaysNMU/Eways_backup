...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2 class="text-center border border-primary">STRESS MANAGEMENT</h2><br>
        ...
        <div>
            <a class="btn btn-secondary float-right" href="<?php echo site_url() ?>/stress_management_p2">Next</a>
        </div>
