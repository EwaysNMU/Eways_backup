...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2 class="text-center border border-primary">STUDY STRATEGIES</h2><br>
        ...
        <div>
            <a class="btn btn-secondary float-right" href="<?php echo site_url() ?>/study_strategy_p2">Next</a>
        </div>
