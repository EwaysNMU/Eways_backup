...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div>
                <a class="btn btn-secondary float-left" href="<?php echo site_url() ?>/goals_settings" role="button">Previous</a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="<?php echo site_url() ?>/goals_setting_feedback_form" role="button">Ok</a>
                        </div>
                    </div>
                </div>
            </div>
