...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2 class="text-center border border-primary">GOALS SETTING</h2><br>



            <p class="text-justify"><img src="<?php echo base_url() ?>/assets/images/goal.jpg" class="rounded float-left"  alt="goal picture"><h4>What is Goal setting?</h4>Goal setting is the process of deciding what you want to accomplish and devising a
        ...
        <h4>Why is it important to create a plan?</h4>
        ...
        <h4>What's the Difference Between a Personal Goal and a Business Goal?</h4>
