...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2 class="text-center border border-primary">MOTIVATION</h2>
            ...
            <div>
                <a class="btn btn-secondary float-left" href="<?php echo site_url() ?>/motivation" role="button">Previous</a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="<?php echo site_url() ?>/motivation_feedback_form" role="button">Ok</a>
                        </div>
                    </div>
                </div>
            </div>
