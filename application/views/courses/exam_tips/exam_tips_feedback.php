...
<body>
	...
	<div class="container">
		<h2 class="text-center">TIPS FOR EXAMS & TESTS FEEDBACK</h2>

		<?php $attributes = array('class' => 'was-validated', 'id' => 'exam_tips_feedback');?>
		<?php echo form_open('exam_tips_feedback', $attributes);?>
