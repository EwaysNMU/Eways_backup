        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tips for Exams & Tests</li>
                </ol>
            </nav>
            <div class="clearfix"></div>
            <h2 class="text-center border border-primary">Tips for Exams & Tests</h2>
            ...
            <div>
                <a class="btn btn-secondary float-left" href="<?php echo site_url() ?>/exam_tips" role="button">Previous</a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="<?php echo site_url() ?>/exam_tips_feedback_form" role="button">Ok</a>
                        </div>
                    </div>
                </div>
            </div>
