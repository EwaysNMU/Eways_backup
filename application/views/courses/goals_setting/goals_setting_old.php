...
<div class="container">
	...
	<h2 class="text-center border border-primary">GOALS SETTING</h2>

	<p class="text-justify"><img src="<?php echo base_url()?>/assets/images/goal.jpg" class="rounded float-left"  alt="goal picture">Goal setting is the process of deciding what you want to accomplish and devising a
