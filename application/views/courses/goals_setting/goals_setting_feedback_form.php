...
<body>
	...
	<div class="container">
		<h2 class="text-center">GOALS SETTING FEEBACK</h2>

		<?php $attributes = array('class' => 'was-validated', 'id' => 'gooal_setting_feedback');?>
		<?php echo form_open('goal_setting_feedback', $attributes);?>
